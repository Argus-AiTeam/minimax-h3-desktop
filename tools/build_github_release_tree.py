...
Current delivery-gate evidence is CPU/static and packaging-only except for already-written GPU evidence that is only read, not rerun: the checked-in reports record CPU/static tests, fixture verification, Turbo dry-run planning, strict aggregation, sanitized export build, publication audit with 0 issues, a terminal Sol-Attn r8 N=3 matched-workload route gate, a terminal formal Sol-Attn r8 N>=10 short-lane acceptance, and a bounded 30-second final-AV r10 formal N=10 extension/chunked acceptance. These gates do not certify BF16 fidelity for Sol-Attn, native long context, Turbo semantic quality, quality equivalence, human listening, public release, product readiness, public comparison, SOTA, or tag creation.
