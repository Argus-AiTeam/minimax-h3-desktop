...
- Previous formal-N10 nonterminal report-sync export/publication audit gate: `pass` for the earlier nonterminal boundary; evidence `delivery/formal_n10_cpu_sync_export_audit_20260812T032659Z/summary.json`; export_file_count=83; publication_audit=pass; issues=0; reviewer_status=pending_not_spawned_in_this_turn; push_performed=False. The latest live recheck `delivery/formal_n10_live_recheck_20260812T035433Z/summary.json` was synced to reports/progress only; no new export/publication audit, Reviewer, commit, or push was run for this still-running formal gate.
...
- R8 formal N>=10 matched-workload gate: `incomplete_formal_n10_running_no_terminal_decision`; evidence `sol_engine_port/sol_attn_h3_formal_n10_r8_n10_20260812T031757Z/formal_n10_supervisor_status.json`; live recheck `delivery/formal_n10_live_recheck_20260812T035433Z/summary.json`; requested_pairs=10; started_pairs=3; completed_pairs=2; supervisor_status=running. Reason: both supervisor processes were alive at the fresh recheck, supervisor stdout shows pair03 started at 2026-08-12T03:54:33Z, pair01 and pair02 have per-pair success/`sparse_runtime_valid` diagnostics, pair03 has no terminal per-pair artifacts yet, and the run still has no formal_n10_decision.json/RUN_REPORT terminal artifacts. The run is not accepted, rejected, or a speedup claim until terminal per-pair evidence and summary are present. Nonterminal/incomplete formal evidence is not a Sol-Attn speedup, BF16 fidelity, release, or quality-equivalence claim.
...
- Sol-Attn matched-workload correctness/quality and performance promotion is complete. Status: incomplete_formal_n10_running_no_terminal_decision Evidence: `sol_engine_port/sol_attn_h3_formal_n10_r8_n10_20260812T031757Z/formal_n10_supervisor_status.json`, `delivery/formal_n10_live_recheck_20260812T035433Z/summary.json`.
